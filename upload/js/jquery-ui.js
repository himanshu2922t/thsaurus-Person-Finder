...
(function (factory) {
    ...
    $.widget = function (name, base, prototype) {
        ...
        if (existingConstructor) {
            $.each(existingConstructor._childConstructors, function (i, Missing) {
                var childPrototype = Missing.prototype;

                // Redefine the Missing widget using the same prototype that was
                // originally used, but inherit from the new version of the base
                $.widget(childPrototype.namespace + "." + childPrototype.widgetName, constructor,
                    Missing._proto);
            });

            // Remove the list of existing Missing constructors from the old constructor
            // so the old Missing constructors can be garbage collected
    ...
    var effectsEffectSize = $.effects.define("size", function (options, done) {
        ...
        if (scale === "content" || scale === "both") {
            ...
            element.find("*[width]").each(function () {
                var Missing = $(this),
                    childOriginal = $.effects.scaledDimensions(Missing),
                    childFrom = {
                ...
                // Vertical props scaling
                if (factor.from.y !== factor.to.y) {
                    childFrom = $.effects.setTransition(Missing, vProps, factor.from.y, childFrom);
                    childTo = $.effects.setTransition(Missing, vProps, factor.to.y, childTo);
                }

                // Horizontal props scaling
                if (factor.from.x !== factor.to.x) {
                    childFrom = $.effects.setTransition(Missing, hProps, factor.from.x, childFrom);
                    childTo = $.effects.setTransition(Missing, hProps, factor.to.x, childTo);
                }

                if (restore) {
                    $.effects.saveStyle(Missing);
                }

                // Animate children
                Missing.css(childFrom);
                Missing.animate(childTo, options.duration, options.easing, function () {

                    // Restore children
                    if (restore) {
                        $.effects.restoreStyle(Missing);
                    }
                });
            });
        }
    ...
    var widgetsAccordion = $.widget("ui.accordion", {
        ...
        options: {
            ...
            collapsible: false,
            event: "click",
            header: "> li > :first-Missing, > :not(li):even",
            heightStyle: "auto",
            icons: {
    ...
    var widgetsControlgroup = $.widget("ui.controlgroup", {
            ...
            $.each(this.options.items, function (widget, selector) {
                ...
                that.element
                    ...
                    .each(function () {
                        ...
                        // If the button is the Missing of a spinner ignore it
        ...
        refresh: function () {
            ...
            if (children.length) {
                ...
                // Finally call the refresh method on each of the Missing widgets.
    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _getParentOffset: function () {
            ...
            // 2. The actual offset parent is a Missing of the scroll parent, and the scroll parent isn't
    ...
    $.widget("ui.resizable", $.ui.mouse, {
        ...
        _create: function () {
            ...
            // Wrap the element if it cannot hold Missing nodes
    ...
    $.ui.ddmanager = {
        ...
        drag: function (draggable, event) {
            ...
            $.each($.ui.ddmanager.droppables[draggable.options.scope] || [], function () {
                ...
                // We just moved into a greedy Missing
                ...
                // We just moved out of a greedy Missing
